...
<form class="input-form" action="/articleSave" method="get">
    ...
    <div class="left-column">
        ...
        <textarea id="subtitle" name="subtitle">${subTitle}</textarea>
    </div>
    <div class="right-column">
        ...
        <input type="text" id="metatitle" name="metatitle" value="${metaTitle}">
    ...
    <div class="full-width">
        ...
        <textarea id="summaryEditor" name="summary">${summary}</textarea>
    </div>
    <div class="full-width">
        <label for="contentEditor">Newsletter Content</label>
        <textarea id="contentEditor" name="content">${newsletterContent}</textarea>
    </div>
